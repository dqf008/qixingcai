...
var __ss = {
    ...
    __int_danshuang: function() {
        ...
        1 == d_checkeds ? (this.__dan_start = !0, this.__dan_reg += "[13579]") : this.__dan_reg += 1 == s_checkeds ? "[02468" + this.__fuhao + "]": "[0-9" + this.__fuhao + "]",
        1 == s_checkeds ? (this.__shuang_start = !0, this.__shuang_reg += "[02468]") : this.__shuang_reg += 1 == d_checkeds ? "[13579" + this.__fuhao + "]": "[0-9" + this.__fuhao + "]",
