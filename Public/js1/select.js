var __ss={
  ...
  __shows:function (){
    ...
    $('psgdstr').style.display="none";
    if($("__dingwei_qu").checked||$("__dingwei_chu").checked){
      $('s12').style.display="none";

    }
    if(this.__classid>3 && ($("__peishu_qu2").checked||$("__peishu_chu2").checked)){
      $('s12').style.display="";

    }
    if(this.__classid!=3){
      $('psgdstr').style.display="none";
    }else if(this.__classid==3&& ($("__peishu_qu").checked||$("__peishu_chu").checked)){
      $('psgdstr').style.display="";
    }
    $("s13").style.display="";
    for(var i=1;i<=10;i++){
      $("ss"+i).style.display="";
...
nnnn++;
  ...
  __showpeishu:function(to){
    if(to=='__dingwei_qu'||to=="__dingwei_chu"){
      ...
      $('s3').style.display="";
      $('s12').style.display="none";
      if(this.__classid==3)$('psgdstr').style.display="none";
      ...
      $('s12').style.display="";
      if(this.__classid==3)$('psgdstr').style.display="";
    }
  }
