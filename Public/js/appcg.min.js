...
var cgOrber = {
			...
			if(json.code==200){
				...
				for(var i=0;i<10;i++){
					if(data[i]==undefined){
						...
						if(data[i]['js']==0){
							html+='<tr><td>七星彩</td><td>'+data[i]['did']+'</td><td class="number">'+data[i]['mingxi_2']+'<span>'+data[i]['mingxi_3']+'</span></td><td class="frank">'+data[i]['odds']+'</td><td class="money">'+data[i]['money']+'</td><td>成功</td><td>';
							if(data[i]['t_status']==1){
								html+='<input id="checkboxID'+data[i]['id']+'" class="'+data[i]['t_status']+'" type="checkbox" value="'+data[i]['id']+'">';
							}else{
								html+='--';
							}
							// html+='<input id="checkboxID'+data[i]['id']+'" type="checkbox" value="'+data[i]['id']+'">';
		...
		init: function() {
			$("#sendnumber").KdlimitMoneyX(),
				...
				$("#checkboxALLID").unbind("click").click(function() {
					...
					//       //$("#SoonOrder input[type=checkbox]").checkBox("all")
					//     }
					//  });
					// }else{
	...
	cgCheckSend = {
		...
		sendTuima: function() {
			...
			"" == strid || jsonAjax("/index.php/Index/tuima", "GET", "action=ordertuima&tuimaid=" + strid, "json", cgCheckSend.showSendTuima)
		},
...
var __ss = {
	...
	cgDetail = {
		...
		Tuima: function() {
			...
			"" == strid || jsonAjax("/index.php/Index/tuima", "GET", "action=ordertuima&tuimaid=" + strid, "json", cgDetail.funcTuima)
		},
			...
			if(code==200){
				...
				for(var i=0;i<data.length;i++){
					if(data[i]['js']==0){
						...
						if(data[i]['t_status']==1){
							html+='<input id="checkboxID'+data[i]['id']+'"  type="checkbox" value="'+data[i]['id']+'" class="chebox" >';
						}else{
							html+='--';
						}
		...
		init: function() {
			$("#detailsearchnumber").limitMoneyX(),
				...
				$("#DetailcheckboxALLID").unbind("click").click(function() {
					...
					//       if(!$(this).is(':disabled')){
					//        $(this).prop('checked',true);
					//         //$("#DetailList input[type=checkbox]").checkBox("all")
					//       }
					//    });
					//   }else{
					//        $("#DetailList input[type=checkbox]").checkBox("none")
					//   }
