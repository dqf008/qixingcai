...
cgCheckSend = {
    ...
    sendTuima: function() {
        ...
        "" == strid || jsonAjax("appindexajax.php", "POST", "action=ordertuima&tuimaid=" + strid, "json", cgCheckSend.showSendTuima)
    },
...
cgDetail = {
    ...
    Tuima: function() {
        ...
        "" == strid || jsonAjax("appindexajax.php", "POST", "action=ordertuima&tuimaid=" + strid, "json", cgDetail.funcTuima)
    },
...
cgErZiDing = {
    ...
    childclick: function(id) {
        ...
        $("#rdcount").text(0),
        $("#rdmoney").text(0),
        jsonAjax("appindexajax.php", "get", "action=erziding&childid=" + id, "json", cgErZiDing.GetReZiDing)
    },
    ...
    moshi: function(s, stat) {
        ...
        jsonAjax("appindexajax.php", "get", "action=erziding" + str + "&childid=" + cgErZiDing.childid, "json", cgErZiDing.GetReZiDing)
    },
    init: function() {
