...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 拦货明细 <span class="c-gray en">&gt;</span> 拦货明细列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<form action="/Data/download" method="post">
  ...
  function findData(){
    ...
    window.location.href="/Data/intercept?qishu="+qishu+'&uname='+uname+'&number='+number+'&xian='+xian+'&condition='+condition+'&start='+start+'&finish='+finish+'&category='+category+'&types='+types;
  }
  </script>
   <div class="mt-20">
